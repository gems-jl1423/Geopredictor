...
class permeability_predict:
    ...
    def model(self):
        """
        Defines, trains, and stores an RandomForestRegressor model using the class's training data.
    
        This method is responsible for processing the training data, defining the RandomForestRegressor model,
        ...
        final_pipeline = Pipeline([
            ('data_pipe', data_pipe),
            ('Regressor', RandomForestRegressor(max_depth=3, n_estimators=200, min_samples_leaf=300, min_samples_split=10, max_features=64))])
